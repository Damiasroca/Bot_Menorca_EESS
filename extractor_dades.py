...
def estacions_servei_extraccio_benzina_ascendent():
    try:
        ...
        if conn.is_connected():
            cursor = conn.cursor()
            cursor.execute("""SELECT Localidad, `Rótulo`, `Precio Gasolina 95 E5`, `Precio Gasoleo A`, `Dirección`, Latitud, `Longitud (WGS840)`
...
def estacions_servei_extraccio_diesel_A_ascendent():
    try:
        ...
        if conn.is_connected():
            cursor = conn.cursor()
            cursor.execute("""SELECT Localidad, `Rótulo`, `Precio Gasoleo A`, `Dirección`, Latitud, `Longitud (WGS840)`
...
def carburants_extraccio_diesel_B_ascendent():
    try:
        ...
        if conn.is_connected():
            cursor = conn.cursor()
            cursor.execute("""SELECT Localidad, `Rótulo`, `Precio Gasoleo B`, `Dirección`, Latitud, `Longitud (WGS840)`
...
def carburants_extraccio_diesel_premium_ascendent():
    try:
        ...
        if conn.is_connected():
            cursor = conn.cursor()
            cursor.execute("""SELECT Localidad, `Rótulo`, `Precio Gasoleo Premium`, `Dirección`, Latitud, `Longitud (WGS840)`
...
def carburants_extraccio_GLP_ascendent():
    try:
        ...
        if conn.is_connected():
            cursor = conn.cursor()
            cursor.execute("""SELECT Localidad, `Rótulo`, `Precio Gases Licuados del petróleo`, `Dirección`, Latitud, `Longitud (WGS840)` 
...
def extraccio_FORNELLS_ascendent():
    try:
        ...
        if conn.is_connected():
            cursor = conn.cursor()
            cursor.execute("""SELECT `Rótulo`, `Dirección`, `Precio Gasolina 95 E5`, `Precio Gasoleo A`, Latitud, `Longitud (WGS840)` 
...
def extraccio_distribuidora_AUTONET():
    try:
        ...
        if conn.is_connected():
            cursor = conn.cursor()
            cursor.execute("""SELECT `Rótulo`, Localidad, Latitud, `Longitud (WGS840)`, `Dirección`
